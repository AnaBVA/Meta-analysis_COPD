...
Here, the authors measured 15 lung samples, 5 controls, 5 “usual” emphysema and 5 AAD emphysema. The raw data is in cel files, the platform used is [Hu6800] Affymetrix. The study was perfomed in Colorado, USA.
...
```{r class.source="bg-danger"}
pData(geo2)["Disease"] <- str_count(as.character(pData(qGSE[[2]][[1]])[,"title"]),"L")
