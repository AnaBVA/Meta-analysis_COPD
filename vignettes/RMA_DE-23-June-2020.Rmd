...
knitr::opts_chunk$set(echo = TRUE,timeit=TRUE)
```
...
# It gets the genes with the p-values
res <- topTable(ebf, number = Inf, p.value = 1, coef = "t1$disease.state.ch1Chronic Obstructive Lung Disease",confint=T)
