...
# meta <- read.csv(OUTPUT("2020-10-16_Step6_meta-analysis.csv"))
...
qval_cutoff <- 0.1
genesqval <- meta[meta$qval <= qval_cutoff,]
write.csv(genesqval[which(genesqval$genes %in% tfs$TF),], OUTPUT(c(TODAY,"_Step6_TF-",qval_cutoff,"-meta-analysis.csv")))
