...
m <- m[comb_degree(m) >= 8 | comb_degree(m) == 1]
...
for (i in gm) {
  ...
  res <- metafor::rma(yi, sei=sei,control=list(stepadj=.5,maxiter=1000))
  num_exp <- sum(!is.na(yi))
...
<div class="alert alert-success">
  ...
  <strong>Table:</strong> Results from the meta-analysis `r OUTPUT(TODAY,"_Step6_meta-analysis.csv")` 
</div>
