...
# Genes with a adjusted p value les than 0.01
adj-pvalue <- 0.01
...
Then, we look for how many genes are up regulated with a p-value less than `r  adj-pvalue`  in the 
