...
```{r experiments}
gse_table <- read.csv(OUTPUT("2020-10-05_GSE_Summary.csv"), row.names = 1)
...
write_csv(de,path= OUTPUT(c("DE/",TODAY,"_TableGenes_",i,"_",names(geo[i]),".csv")))
...
write_csv(r,path= OUTPUT(c("DE/",TODAY,"_TableGenes_",names(geo[i]),".csv")))
