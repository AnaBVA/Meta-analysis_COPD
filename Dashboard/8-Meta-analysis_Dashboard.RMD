...
```{r}
gse_table <- read.csv(here::here("output_data/2020-10-07_Step3_Summary.csv"), row.names = 1)
...
```{r}
# Data
full_tables <- read_csv(here::here("output_data/2020-10-08_Step5_Full_Tables.csv"))
meta <- read_csv(here::here("output_data/2020-10-16_Step6_meta-analysis.csv"))[,-1]
