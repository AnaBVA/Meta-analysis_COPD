...
```{r}
meta <- read_csv(OUTPUT("2021-02-01_Step6_meta-analysis.csv"))
meta
```
...
up_kegg_obj <- hypeR(up_signature, 
 ...
 up_kegg <-  hyp_dots(up_kegg_obj) + theme_minimal(14) + xlab("KEGG")
 ...
 up_hall <-  hyp_dots(up_hall_obj) + theme_minimal(14) + xlab("HALLMARL")
...
down_kegg_obj <- hypeR(down_signature, 
 ...
 down_kegg <-  hyp_dots(down_kegg_obj) + theme_minimal(14) + xlab("KEGG")
 ...
 down_hall <-  hyp_dots(down_hall_obj) + theme_minimal(14) + xlab("HALLMARL")
