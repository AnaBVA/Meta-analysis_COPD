...
#dev.off()
comb_size(m)
up[extract_comb(m,"11001101000"),]
up[extract_comb(m,"10001111000"),]
...
comb_size(m)
down[extract_comb(m,"01001111000"),]
down[extract_comb(m,"10001111000"),]
...
full_tables <- read_csv(OUTPUT("2020-10-08_Step5_Full_Tables_SE.csv"))
```
...
pdf(FIG("forestplot_CYP4B1.pdf"), width = 10, height = 4.5)
meta.plot("CYP4B1")
dev.off()

pdf(FIG("forestplot_CXCL1.pdf"), width = 10, height = 4.5)
meta.plot("CXCL1")
dev.off()

pdf(FIG("forestplot_CCL2.pdf"), width = 10, height = 4.5)
meta.plot("CCL2")
dev.off()
...
meta_degs_rem <- rem_mv(diffexp=diffexplist,
            ...
            metathr=0.05,
            jobname="MetaVolcano",
            outputfolder=here::here("Tissue/output_data"), 
            draw='HTML',
            ncores=1)
